...
public interface MicrosoftGraphCredentialService extends ControllerService {
    ...
    public final static PropertyDescriptor AUTH_CLIENT_ID = new PropertyDescriptor
            ...
            .description("Specifies the enterprise application client id")
            .required(true)
    ...
    public final static PropertyDescriptor AUTH_TENANT_ID = new PropertyDescriptor
            ...
            .description( "Specifies the enterprise application client API Key")
            .required(true)
            .expressionLanguageSupported(ExpressionLanguageScope.VARIABLE_REGISTRY)
            .addValidator(  StandardValidators.NON_BLANK_VALIDATOR)
            .sensitive(false)
    ...
    public final static PropertyDescriptor AUTH_CLIENT_SECRET = new PropertyDescriptor
            ...
            .description("Specifies the enterprise application client Secret")
            .required(true)
            .expressionLanguageSupported(ExpressionLanguageScope.VARIABLE_REGISTRY)
            .sensitive(true)
            .addValidator(StandardValidators.NON_BLANK_VALIDATOR)
    ...
    public final static PropertyDescriptor AUTH_GRANT_TYPE = new PropertyDescriptor
            ...
            .description("Specifies the enterprise application Grant Type")
            .required(true)
            .expressionLanguageSupported(ExpressionLanguageScope.VARIABLE_REGISTRY)
    ...
    public final static PropertyDescriptor AUTH_SCOPE = new PropertyDescriptor
            ...
            .description("Specifies the enterprise application client Scope")
            .required(true)
            .expressionLanguageSupported(ExpressionLanguageScope.VARIABLE_REGISTRY)
